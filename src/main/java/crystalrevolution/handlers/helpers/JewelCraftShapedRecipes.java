...
public class JewelCraftShapedRecipes implements IRecipe
{
    ...
    public JewelCraftShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public JewelCraftShapedRecipes func_92100_c()
    {
